...
import com.yydb.common.repository.support.SimpleBaseRepositoryFactoryBean;
import com.yydb.sys.auth.service.UserAuthService;
import com.yydb.sys.user.entity.User;
import com.yydb.sys.user.exception.*;
import com.yydb.sys.user.service.UserService;
...
public class UserRealm extends AuthorizingRealm {
    ...
    private static final Logger log = LoggerFactory.getLogger("yydb-error");

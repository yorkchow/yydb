...
/**
 * {@link org.springframework.data.repository.query.RepositoryQuery} implementation that inspects a {@link org.springframework.data.repository.query.QueryMethod}
 * for the existanve of an {@link org.springframework.data.jpa.repository.Query} annotation and creates a JPA
 * {@link javax.persistence.Query} from it.
 *
...
final class SimpleJpaQuery extends AbstractJpaQuery {
    ...
    /**
     * Creates a new {@link org.springframework.data.jpa.repository.query.SimpleJpaQuery} that encapsulates a simple query string.
     */
    ...
    /**
     * Creates a new {@link org.springframework.data.jpa.repository.query.SimpleJpaQuery} encapsulating the query annotated on the given {@link org.springframework.data.jpa.repository.query.JpaQueryMethod}.
     */
    ...
    /**
     * Creates a {@link org.springframework.data.repository.query.RepositoryQuery} from the given {@link org.springframework.data.repository.query.QueryMethod} that
     * is potentially annotated with {@link org.springframework.data.jpa.repository.Query}.
     *
     * @param queryMethod
     * @param em
     * @return the {@link org.springframework.data.repository.query.RepositoryQuery} derived from the annotation or {@code null} if no annotation found.
     */

package com.yydb.common.web.bind.method.annotation;

import com.google.common.collect.Lists;
import com.yydb.common.web.bind.annotation.PageableDefaults;
...
public class PageableMethodArgumentResolver extends BaseMethodArgumentResolver {
    ...
    /**
     * Setter to configure a fallback instance of {@link org.springframework.data.domain.Pageable} that is being used to back missing parameters. Defaults
    ...
    /**
     * Asserts uniqueness of all {@link org.springframework.data.domain.Pageable} parameters of the method of the given {@link org.springframework.core.MethodParameter}.
     *
     * @param parameter
     */
    ...
    /**
     * Returns whether the given {@link java.lang.reflect.Method} has more than one {@link org.springframework.data.domain.Pageable} parameter.
     *
     * @param method
     * @return
     */
    ...
    /**
     * Asserts that every {@link org.springframework.data.domain.Pageable} parameter of the given parameters carries an {@link org.springframework.beans.factory.annotation.Qualifier} annotation to
    ...
    /**
     * Returns a {@link org.springframework.beans.factory.annotation.Qualifier} annotation from the given array of {@link java.lang.annotation.Annotation}s. Returns {@literal null} if the
